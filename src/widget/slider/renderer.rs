...
pub use super::style::{Handle, HandleShape, Style, StyleSheet};
pub use super::widget::State;

/// An horizontal bar and a handle that selects a single value from a range of values.
///
/// This is an alias of an `iced_native` slider with an `iced_wgpu::Renderer`.
pub type Slider<'a, T, Message, Backend> = super::widget::Slider<'a, T, Message, Renderer<Backend>>;

impl<B> super::widget::Renderer for Renderer<B>
where
    B: Backend,
{
    ...
    fn draw(
        ...
        let handle = Primitive::Quad {
            bounds: Rectangle {
                ...
                y: rail_y - handle_height / 2.0 + rail_height / 2.0,
                width: handle_width,
